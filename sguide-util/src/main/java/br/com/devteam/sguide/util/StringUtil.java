...
public final class StringUtil 
{
	 ...
	 * @return {@link Boolean} True if has text / False if not
	 */
	public static Boolean hasText(String str)
	{
		String check = String.valueOf(str);
		if(check.equals("null") || check.equals("") || check.replaceAll("\\s", "").equals(""))
			return false;
		return true;
	}
	...
	/**
	 * Check if the {@link Object} has toString value
	 ...
	 * @param {@link String} occurrence
	 * @return {@link Integer} containing the count
	 */
	public static Integer occurrencesOf(String value, String find) 
	{
		if(!hasText(value) || !hasText(find)) return 0;
		
		Integer qtd = 0;
		Integer pos = 0;
		Integer idx;
		while ((idx = value.indexOf(find, pos)) != -1) 
		{
			++qtd;
			pos = idx + find.length();
		}
